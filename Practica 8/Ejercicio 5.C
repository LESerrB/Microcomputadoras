/*Realizar las modificaciones necesarias al ejercicio 2 de la práctica tres para
  que ahora el comando que selecciona la acción sea a través del puerto serie,
  usar retardos de ½ segundos, usando programación en C.
     TECLA  |          ACCION
            |         Puerto B
-------------------------------------------
       0    |  Todos los bits
