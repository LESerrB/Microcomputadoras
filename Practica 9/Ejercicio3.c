/*  Realizar un programa el cual constantemente transmita el resultado de la conversión a la
    terminal, y cada 30 segundos interrumpa la ejecución de este y envíe un mensaje */
#include <16f877.h>
#device ADC=10
#fuses HS,NOPROTECT,
...
void main(){
     ...
     while(1){
        delay_us(20);                                // Retardo 
        var=read_adc();                              // Resultado de la Conversión
        delay_us(20);
